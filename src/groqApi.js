...
Debe tener exactamente esta estructura:
{
  ...
  "technique": {
    ...
    "schema": "Los dibujos ASCII de TODOS los acordes o posiciones del riff de la canción. Debes escribir todos los esquemas necesarios, uno debajo de otro (separados por una línea en blanco), indicando el nombre del acorde encima de cada uno. Dibuja SIEMPRE las 6 cuerdas aunque no se toquen, y añade una primera fila con los números de traste en números romanos usando los caracteres Unicode de ancho simple (Ⅰ, Ⅱ, Ⅲ, Ⅳ) perfectamente alineados sobre el guion central de cada traste. EMPIEZA ESA FILA con la palabra 'TS' seguida de 6 espacios vacíos. Usa 1,2,3,4 para los dedos, O (al aire) y X (no suena) al inicio. Ejemplo:\\nRe Mayor (D):\\nTS      Ⅰ   Ⅱ   Ⅲ\\nE (1) |---|-2-|---\\nB (2) |---|---|-3-\\nG (3) |---|-1-|---\\nD (4) O---|---|---\\nA (5) X---|---|---\\nE (6) X---|---|---\\n\\nDo Mayor (C):\\nTS      Ⅰ   Ⅱ   Ⅲ\\nE (1) O---|---|---\\nB (2) |-1-|---|---\\nG (3) O---|---|---\\nD (4) |---|-2-|---\\nA (5) |---|---|-3-\\nE (6) X---|---|---\\n"
  },
  "notes": [
